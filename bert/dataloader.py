...
def setup_bert(use_tpu, do_lower_case, bert_large, output_dir=None, tpu_name=None, tpu_zone=None,
    ...
    if use_tpu:
        # First you need to download everything and upload to cloud storage
        # gsutil cp -R gs://cloud-tpu-checkpoints/bert/cased_L-12_H-768_A-12/ gs://swag-tpu/bert_models/
        # gsutil cp -R gs://cloud-tpu-checkpoints/bert/uncased_L-12_H-768_A-12/ gs://swag-tpu/bert_models/
        # gsutil cp -R gs://cloud-tpu-checkpoints/bert/uncased_L-24_H-1024_A-16/ gs://swag-tpu/bert_models/
        # wget https://storage.googleapis.com/bert_models/2018_10_18/cased_L-24_H-1024_A-16.zip && unzip cased_L-24_H-1024_A-16.zip && gsutil cp -R cased_L-24_H-1024_A-16/ gs://swag-tpu/bert_models/
        assert do_lower_case or (not bert_large)
